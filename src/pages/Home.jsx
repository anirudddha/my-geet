  ...
  return (
    <div className="container my-3">
      ...
      <div className="about my-3 mx-10">
        <h2 >About us</h2>
        <p>Welcome to My Geet Studios, where music meets creativity and customization. <br />
          ...
          create is as exceptional as your project demands. <br />`x`
          Whether you're a filmmaker, advertiser, game developer, or event organizer, we're
          committed to delivering music that not only meets but exceeds your expectations. </p>
      </div>
